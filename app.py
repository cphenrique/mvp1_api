...
apoio_tag = Tag(name='Tabelas de apoio', description='Tabelas de apoio para o cadastro de um Projeto (Categoria, Gerente, Status)')
...
@app.get('/categorias', tags=[apoio_tag])
def get_categorias():
...
@app.get('/gerentes', tags=[apoio_tag])
def get_gerentes():
...
@app.get('/statuses', tags=[apoio_tag])
def get_statuses():
